copy "launcher\temp\tp-update\tpud-items\tpudit-modpack\modpack -v1\mp-mover\udmp-mover.bat" "launcher\temp\tp-update\tpud-mover\tpudmp-mover"
...
if exist "C:\Users\acer\Downloads\lithium-fabric-mc1.18.2-0.10.3.jar", "C:\Users\acer\Downloads\iris-mc1.18.2-1.4.5.jar" (
    copy "C:\Users\acer\Downloads\lithium-fabric-mc1.18.2-0.10.3.jar", "C:\Users\acer\Downloads\iris-mc1.18.2-1.4.5.jar" "launcher\temp\tp-update\tpud-mp\tpud-items\tpudit-modpack\modpack -v1\modpack"

    move "launcher\modpack\mp-setup\iris-mc1.18.2-1.4.2.jar", "launcher\modpack\mp-setup\lithium-fabric-mc1.18.2-0.10.2.jar" "launcher\bassic\update\ud-modpack\udmp-backup\mp-first"
    move "cilent\cilent mods\cm-launcher\cmlc-bassic\cmlc-update\cmlcud-new" "cilent\cilent mods\cm-launcher\cmlc-bassic\cmlc-update\cmlcud-backup\mp-first"

    copy "launcher\temp\tp-update\tpud-items\tpudit-modpack\modpack -v1\modpack" "launcher\modpack\mp-setup"
) else (
